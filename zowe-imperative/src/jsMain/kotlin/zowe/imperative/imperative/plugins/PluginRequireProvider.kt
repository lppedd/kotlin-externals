...
import zowe.imperative.imperative.plugins.errors.PluginRequireAlreadyCreatedError
import zowe.imperative.imperative.plugins.errors.PluginRequireNotCreatedError

/**
 * This class will allow imperative to intercept calls by plugins so that it can provide them with
 * the runtime instance of imperative / base cli when necessary.
 *
 * Currently this loader is only available from Imperative's internals but work could be
 * done to make this a true standalone package that either Imperative depends on or ships as a
 * separate folder under packages.
 *
 * **Proper Use of the Module Loader**:
 * ```
 ...
 * // Will now cause this to act as normal regardless of how it would have been // injected before.
 * require("module-b");
 * ```
 */
external class PluginRequireProvider {
  companion object {
    /**
     ...
     */
    fun createPluginHooks(modules: Array<String>)

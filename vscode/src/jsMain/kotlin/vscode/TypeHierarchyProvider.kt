...
external interface TypeHierarchyProvider {
   ...
   * @return One or multiple type hierarchy items or a thenable that resolves to such. The lack of a result can be
   ...
   * @param token A cancellation token.
   * @return A set of direct supertypes or a thenable that resolves to such. The lack of a result can be
   *   signaled by returning `undefined` or `null`.
   */
  fun provideTypeHierarchySupertypes(
    item: TypeHierarchyItem,
    token: CancellationToken,
  ): ProviderResult<Array<TypeHierarchyItem>>
   ...
   * @param token A cancellation token.
   * @return A set of direct subtypes or a thenable that resolves to such. The lack of a result can be
   *   signaled by returning `undefined` or `null`.
   */

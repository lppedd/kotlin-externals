...
/**
 * A debug adaper factory that creates [DebugAdapterDescriptor debug adapter descriptors].
 */
...
/**
   ...
   *      return executable;
   *   }
   * @param session The [DebugSession debug session] for which the debug adapter will be used.
   * @param executable The debug adapter's executable information as specified in the package.json (or undefined if no such information exists).
   * @return a [DebugAdapterDescriptor debug adapter descriptor] or undefined.
   */

...
external interface Pseudoterminal {
  ...
  /**
   * An event that when fired allows overriding the [Pseudoterminal.setDimensions dimensions] of the
   ...
   * [Pseudoterminal.onDidOverrideDimensions onDidOverrideDimensions], `setDimensions` will

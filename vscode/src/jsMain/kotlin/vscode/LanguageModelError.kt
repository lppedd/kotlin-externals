 ...
 */
external class LanguageModelError : JsError {
  /**
   * A code that identifies this error.
   *
   * Possible values are names of errors, like [LanguageModelError.NotFound],
   * or `Unknown` for unspecified errors from the language model itself.

...
external interface DocumentColorProvider {
   ...
   * @return An array of [ColorInformation color information] or a thenable that resolves to such. The lack of a result
  ...
  /**
   * Provide [ColorPresentation representations] for a color.
   *

...
external interface Webview {
   ...
   * message passing. To send a message from the extension to the webview, use [Webview.postMessage].
   ...
   * ```
   *
   * To load a resources from the workspace inside a webview, use the [Webview.asWebviewUri] method

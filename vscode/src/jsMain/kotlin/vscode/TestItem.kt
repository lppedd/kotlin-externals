...
external interface TestItem {
   ...
   * aren't yet included in another item's [TestItem.children children].
   */
  val parent: TestItem?
   ...
   * with other items. When `falsy` the [TestItem.label label]
   * is used.
   */
  var sortText: String?

  /**
   * Location of the test item in its [TestItem.uri uri].
   *
   ...
   */
  var error: Any? // string | MarkdownString | undefined
}

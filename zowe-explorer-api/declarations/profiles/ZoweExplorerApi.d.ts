 ...
 */
export declare namespace ZoweExplorerApi {
    /**
    ...
    interface ICommon {
         ...
         */
        getStatus?(profile: zowe.imperative.IProfileLoaded, profileType?: any): Promise<string>;
        /**
         ...
         * @param {zowe.imperative.Session} session a Zowe CLI Session
         */
        logout?(session: zowe.imperative.Session): any;
        /**
     ...
     * @export
     */
    interface IUss extends ICommon {
        /**
     ...
     * @export
     */
    interface IMvs extends ICommon {
        /**
         ...
         * @returns {Promise<zowe.IZosFilesResponse>}
         */
        copyDataSetMember({ dsn: fromDataSetName, member: fromMemberName }: zowe.IDataSet, { dsn: toDataSetName, member: toMemberName }: zowe.IDataSet, options?: {
            replace?: boolean;
     ...
     * @export
     */
    interface ICommand extends ICommon {
        /**
